...
public class Store extends Subject {
	...
	void register(Observer o) {
		...
		ol.add(o);
		System.out.println("Added Customer "+o.name+" to Store "+name);
	}
	...
	void unregister(Observer o) {
		...
		try {
			...
			System.out.println("Removed Customer "+o.name+" from store "+name);
		}
		catch (NullPointerException e) {
			// TODO: handle exception
			System.out.println("No such Customer called "+o.name+" in store "+ name);
		}
